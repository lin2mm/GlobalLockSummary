---
title: "Master Engineering Data Index"
...
<div class="doc-viewer" style="margin: 20px 0;">
  <div class="doc-viewer__actions" style="margin-bottom: 16px; display: flex; gap: 10px; flex-wrap: wrap;">
    <a class="block-hero__btn" href="/docs/GLOBAL_LOCK_DATA_INDEX.md" download style="padding: 6px 14px; font-size: 0.85rem;">
      📥 下载原始文档 (GLOBAL_LOCK_DATA_INDEX.md)
    </a>
  ...
  <pre style="background: var(--bg-alt, #f8fafc); border: 1px solid var(--border, #e2e8f0); border-radius: 8px; padding: 20px; font-family: Consolas, monospace; font-size: 0.88rem; line-height: 1.6; white-space: pre-wrap; word-break: break-word; color: var(--fg, #1e293b);"># GlobalLockSummary: 全局数据、资产与工程索引总览 (Master Data Index)
