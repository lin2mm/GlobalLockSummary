  ...
  <div class="gallery-card" id="adp-01" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 3px solid #0f172a; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.03); display: flex; flex-direction: column;">
    ...
    <div style="padding: 16px; flex: 1; display: flex; flex-direction: column;">
      ...
      <div style="background: #f8fafc; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #334155; border-left: 3px solid #0f172a; margin-bottom: 8px;">
        ...
        <div style="margin-top: 4px;"><b>Material:</b> H62 黄铜 或 淬火碳钢（严禁使用普通锌合金，剪切力不足易断裂）</div>
      </div>
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; color: #64748b; border-top: 1px solid #f1f5f9; padding-top: 8px;">
        <span>Fabrication: <span style="background: #64748b; color: #fff; font-size: 0.65rem; font-weight: 600; padding: 2px 6px; border-radius: 3px;">Mandatory Metal</span></span>
    ...
    <div style="padding: 16px; flex: 1; display: flex; flex-direction: column;">
      ...
      <div style="background: #f8fafc; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #334155; border-left: 3px solid #0f172a; margin-bottom: 8px;">
        ...
        <div style="margin-top: 4px;"><b>Material:</b> 优质不锈钢 SUS304</div>
      </div>
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; color: #64748b; border-top: 1px solid #f1f5f9; padding-top: 8px;">
        <span>Fabrication: <span style="background: #64748b; color: #fff; font-size: 0.65rem; font-weight: 600; padding: 2px 6px; border-radius: 3px;">Mandatory Metal</span></span>
    ...
    <div style="padding: 16px; flex: 1; display: flex; flex-direction: column;">
      ...
      <div style="background: #f8fafc; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #334155; border-left: 3px solid #0f172a; margin-bottom: 8px;">
        ...
        <div style="margin-top: 4px;"><b>Material:</b> 航空铝 7075 阳极氧化 + 3× M3 不锈钢内六角紧定螺钉</div>
      </div>
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; color: #64748b; border-top: 1px solid #f1f5f9; padding-top: 8px;">
        <span>Fabrication: <span style="background: #64748b; color: #fff; font-size: 0.65rem; font-weight: 600; padding: 2px 6px; border-radius: 3px;">Mandatory Metal</span></span>
    ...
    <div style="padding: 16px; flex: 1; display: flex; flex-direction: column;">
      ...
      <div style="background: #f8fafc; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #334155; border-left: 3px solid #0f172a; margin-bottom: 8px;">
        ...
        <div style="margin-top: 4px;"><b>Material:</b> SUS304 不锈钢冲压拉丝</div>
      </div>
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; color: #64748b; border-top: 1px solid #f1f5f9; padding-top: 8px;">
        <span>Fabrication: <span style="background: #64748b; color: #fff; font-size: 0.65rem; font-weight: 600; padding: 2px 6px; border-radius: 3px;">Mandatory Metal</span></span>
    ...
    <div style="padding: 16px; flex: 1; display: flex; flex-direction: column;">
      ...
      <div style="background: #f8fafc; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #334155; border-left: 3px solid #0f172a; margin-bottom: 8px;">
        ...
        <div style="margin-top: 4px;"><b>Material:</b> 65Mn 弹簧钢淬火 + PTFE 自润滑衬垫</div>
      </div>
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; color: #64748b; border-top: 1px solid #f1f5f9; padding-top: 8px;">
        <span>Fabrication: <span style="background: #64748b; color: #fff; font-size: 0.65rem; font-weight: 600; padding: 2px 6px; border-radius: 3px;">Mandatory Metal</span></span>
    ...
    <div style="padding: 16px; flex: 1; display: flex; flex-direction: column;">
      ...
      <div style="background: #f8fafc; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #334155; border-left: 3px solid #0f172a; margin-bottom: 8px;">
        ...
        <div style="margin-top: 4px;"><b>Material:</b> 10.9 级高强高碳钢镀锌 / 淬火防扭曲</div>
      </div>
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; color: #64748b; border-top: 1px solid #f1f5f9; padding-top: 8px;">
        <span>Fabrication: <span style="background: #64748b; color: #fff; font-size: 0.65rem; font-weight: 600; padding: 2px 6px; border-radius: 3px;">Mandatory Metal</span></span>
