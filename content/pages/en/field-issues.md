---
title: "Global Field Failure Gallery & Installation Pitfalls"
slug: "field-issues.html"
lang: "en"
---

# Global Field Failure Gallery
...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 20px; margin: 28px 0;">
  ...
  <div class="gallery-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.04);">
    <div style="height: 155px; background: #0b1120; overflow: hidden; position: relative;">
    ...
    <div style="padding: 12px 14px;">
      <h3 style="margin: 0 0 8px; font-size: 1.05rem;">Strike Plate Binding Caused by Door Sagging</h3>
      <p style="font-size: 0.85rem; color: #475569; line-height: 1.5; margin: 0 0 10px;">Door weight sagging creates heavy shear friction between deadbolt and strike box. Standard retrofit motors (~1.0 N·m) stall quickly, causing battery drain within weeks.</p>
      <div style="background: #fef2f2; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #991b1b; border-left: 3px solid #dc2626;">
        <b>Design Rule:</b> Mandate 3-inch anchor screws into jamb stud to pull hinge plumb; strike cutout bevel ≥2mm.
      </div>
    </div>
  </div>
  ...
  <div class="gallery-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.04);">
    ...
    <div style="padding: 12px 14px;">
      <h3 style="margin: 0 0 8px; font-size: 1.05rem;">Euro Double Cylinder Non-Emergency Lockout</h3>
      <p style="font-size: 0.85rem; color: #475569; line-height: 1.5; margin: 0 0 10px;">Without DIN 18252 BS dual-entry emergency clutch, key inserted on the inside permanently prevents outside physical key insertion, requiring destructive entry if battery fails.</p>
      <div style="background: #fef2f2; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #991b1b; border-left: 3px solid #dc2626;">
        <b>Design Rule:</b> App wizard must mandate confirmation of dual-key emergency clutch cylinder prior to retrofit.
      </div>
    </div>
  </div>
  ...
  <div class="gallery-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.04);">
    ...
    <div style="padding: 12px 14px;">
      <h3 style="margin: 0 0 8px; font-size: 1.05rem;">HDB Metal Security Gate & Wooden Door Clash (<80mm)</h3>
      <p style="font-size: 0.85rem; color: #475569; line-height: 1.5; margin: 0 0 10px;">Clearance between outer mild steel gate and inner wooden door is only 75-90mm. Retrofit bodies thicker than 35mm will crush upon door swing closure.</p>
      <div style="background: #fff7ed; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #9a3412; border-left: 3px solid #ea580c;">
        <b>Design Rule:</b> Keep chassis profile depth under 35mm or employ an offset mounting bracket.
      </div>
    </div>
  </div>
  ...
  <div class="gallery-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.04);">
    ...
    <div style="padding: 12px 14px;">
      <h3 style="margin: 0 0 8px; font-size: 1.05rem;">Lockwood 001 Deadlatch Auxiliary Pin Extension Gap</h3>
      <p style="font-size: 0.85rem; color: #475569; line-height: 1.5; margin: 0 0 10px;">When door gap exceeds 4mm, the auxiliary triangular pin slips into the strike opening instead of depressing, preventing deadlock status while reporting locked.</p>
      <div style="background: #fff7ed; padding: 8px 10px; border-radius: 4px; font-size: 0.75rem; color: #9a3412; border-left: 3px solid #ea580c;">
        <b>Design Rule:</b> Keep door perimeter gap ≤3.0mm; provide stainless steel strike shims to ensure complete pin retraction.
      </div>
    </div>
    <div class="gallery-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.04);">
    <div style="height: 155px; background: #0b1120; overflow: hidden; position: relative;">
