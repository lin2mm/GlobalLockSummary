...
function build() {
  ...
  for (const lang of LANGS) {
    ...
    const casesCards = cases.map(c => {
      ...
      return `<div class="install-case-card" style="background: var(--color-surface, #fff); border: 1px solid var(--color-border, #cbd5e1); border-radius: 6px; overflow: hidden; display: flex; flex-direction: column; box-shadow: 0 2px 6px rgba(0,0,0,0.03);">
