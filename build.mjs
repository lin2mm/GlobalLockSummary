...
function build() {
  ...
  for (const lang of LANGS) {
    ...
    const installGalleryHtml = `<div class="install-gallery-page wrap">
      ...
      <div class="install-filter-bar" style="margin-bottom: 24px; display: flex; gap: 8px; flex-wrap: wrap; background: #f8fafc; border: 1px solid #e2e8f0; border-left: 3px solid #0f172a; padding: 10px 14px; border-radius: 4px;">
