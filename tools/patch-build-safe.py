...
if old_sea_latam in text:
    text = text.replace(old_sea_latam, new_jp_sea_gcc)
    print("Successfully patched build.mjs with 6-block golden array!")
else:
    print("Warning: old_sea_latam block not matched exactly.")
