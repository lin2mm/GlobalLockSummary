...
master_summary_md = """# GlobalLockSummary 仓库全景资料总索引与工程资产摘要 (Repository Master Summary)
...
with open("docs/00_MASTER_REPOSITORY_SUMMARY.md", "w", encoding="utf-8") as f:
    f.write(master_summary_md)

print("Saved docs/00_MASTER_REPOSITORY_SUMMARY.md successfully.")
