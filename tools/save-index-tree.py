...
index_tree_content = """# GlobalLockSummary 全局索引脉络与架构树 (Index Tree)
...
with open("docs/00_INDEX_TREE.md", "w", encoding="utf-8") as f:
    f.write(index_tree_content)

print("Saved docs/00_INDEX_TREE.md successfully.")
